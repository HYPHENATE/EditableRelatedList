...
<br/>
 1 - Click the above link to 'Deploy to Salesforce'
 2 - Select the type of evironment to 'Deploy to'
 3 - Hit 'Login to Salesforce' in the top-right, and enter your credentials
 4 - Git 'Deploy' in the top-right
